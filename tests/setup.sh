...
echo "==> Installing kro operator (latest)..."
kubectl apply -f https://raw.githubusercontent.com/kubernetes-sigs/kro/refs/heads/main/helm/crds/kro.run_resourcegraphdefinitions.yaml
